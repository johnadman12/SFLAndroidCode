...
public class PriceBreakupPerAdapter extends RecyclerView.Adapter<PriceBreakupPerAdapter.FeatureListHolder> {
    private Context mContext;
    private ArrayList<WinningList.Winner> list;

    public PriceBreakupPerAdapter(Context mContext, ArrayList<WinningList.Winner> list) {
    ...
    public FeatureListHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_percentage, parent, false);
