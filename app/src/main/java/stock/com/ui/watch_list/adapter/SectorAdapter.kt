...
class SectorAdapter(val mContext: Context, val searchList: List<WatchListFilterPojo.sector>): RecyclerView.Adapter<SectorAdapter.WatchListHolder>() {
    ...
    override fun onBindViewHolder(holder: WatchListHolder, position: Int) {
        ...
        holder.itemView.tvContestName.setText(searchList.get(position).sector)
